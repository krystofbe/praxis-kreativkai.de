...
gulp.task(
    "dev", ["browserSync", "sass", "minify-css", "minify-js"],
    function() {
...
gulp.task('deploy', function() {
    ...
    return gulp.src(globs, { base: '.', buffer: false })
        .pipe(conn.newer('/praxis-kreativkai.de')) // only upload newer files
        .pipe(conn.dest('/praxis-kreativkai.de'));
